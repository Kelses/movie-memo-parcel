...
const variable = (0, _networkJs.fetchProducts)();
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (journalMovies.length === 0) // Display a message if the journal is empty
    movieContainer.innerHTML = `<p class="text-white">Your journal is empty. Start adding movies!</p>`;
    else // Loop through each movie in the journal and create a movie card for it
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bgbB6","c7nC1"], "c7nC1", "parcelRequire94c2")
